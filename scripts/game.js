...
const popupDiv = document.querySelector(".popUp"),
    ...
    popupOkButton = popupDiv.querySelector(".okButton"),
    ...
    alertPopup = document.querySelector(".youNeedTo"),
    alertResources = document.querySelector(".moreMaterials"),
    alertCondition = document.querySelector(".moreBuildings"),
    alertPopulation = document.querySelector(".morePopulation");
...
function setup() {
    ...
    if(buildingName == "headQuarters"){
        ...
        popupTitle.innerHTML = "Back to Earth !";
    ...
    (e) =>{
        ...
        if((grid[coordX][coordY][2] == 0) && (selection == false)){
                    ...
                    if(conditions == true){
                        if((materials >= buildings[i].materialsPrice) && (energy >= buildings[i].energyPrice)){
                            ...
                            if((buildingNumbers < Math.ceil(pilgrims/3)) || (buildingName == "houses")){
                                ...
                                let temp = [energy, food, materials, pilgrims];
                                alertPopup.style.display = "block";
                                alertPopulation.innerHTML = "";
                                alertResources.innerHTML = "You dont have enough population to increase the size of your colony, build more houses";
                            ...
                            if(missingMat <= 0){
                                alertPopulation.innerHTML = "";
                                alertResources.innerHTML = `Missing ${0} materials and ${missingEne} energy.`;
                                alertCondition.innerHTML = "";
                            }else if(missingEne <= 0){
                                alertPopulation.innerHTML = "";
                                alertResources.innerHTML = `Missing ${missingMat} materials and ${0} energy.`;
                                alertCondition.innerHTML = "";
                            }else{
                                alertPopulation.innerHTML = "";
                                alertResources.innerHTML = `Missing ${missingMat} materials and ${missingEne} energy.`;
                                alertCondition.innerHTML = "";
                            }
                            alertPopup.addEventListener(
                                'click',
                        ...
                        alertPopup.style.display = "block";
                        alertPopulation.innerHTML = "";
                        alertResources.innerHTML = `This building require the construction of: ${buildings[i].condition}`;
                        alertCondition.innerHTML = "";
                        alertPopup.addEventListener(
                            'click',
                            () =>{
            ...
            if(grid[coordX][coordY][3] != "Bollocks"){
                ...
                selectionDiv.style.top = `${(coordY * 100 + 50)}px`;
                selectionDiv.style.left = `${(coordX * 100 + 50)}px`;
...
// let team ={
//     Guillaume: "Le rageux de l'inté",
//     Martin: "Leader de la -creative team-",
//     Raphael: "Le discret",
//     Corto: "Vodka boy",
//     Paul: "L'artiste",
//     Lucas: "Gardien de l'accueil",
//     moral: "",
// }

// const projet = [1, 2, 3, 4, 5];

// for(let i = 0; i < projet.length; i++){
//     if(projet[i] == 1){
//         team.Guillaume = "Désespoir du Gulp";
//         team.Corto = "Anéanti par Gulp";
//         team.Lucas = "Bercé de faux espoirs";
//         team.Martin = "Soutien psychologique";
//         team.moral = "Frustration";
//     }else if(projet[i] == 2){
//         team.Paul = "Flat design";
//         team.Guillaume = "Fou rire du code";
//         team.Corto = "Tableaux";
//         team.Lucas = "Déterminé pour l'accueil";
//         team.Martin = "Pense aux règles";
//         team.Raphael = "Corrige les pensées";
//         team.moral = "Enthousiasme";
//     }else if(projet[i] == 3){
//         team.Paul = "Très flat design";
//         team.Guillaume = "Condamné à l'intégration";
//         team.Corto = "En quête d insultes dans le code";
//         team.Lucas = "En quête de soutien spirituel";
//         team.Martin = "Commence à râler";
//         team.Raphael = "Essaye de parler";
//         team.moral = "Enthousiasme";
//     }else if(projet[i] == 4){
//         team.Paul = "De vie à très-plat";
//         team.Guillaume = "Détruit par l'abondante bêtise du groupe";
//         team.Corto = "Terrassé par la stupidité générale";
//         team.Lucas = "Proche du Nirvana";
//         team.Martin = "Boule de nerfs tyrannique victimisée";
//         team.Raphael = "Abandonne l'idée de parler";
//         team.moral = "Joyeuse Haine";
//     }else if(projet[i] == 5){
//         team.Paul = "Le design de diapo pour le nuls";
//         team.Guillaume = "Malade et mourrant";
//         team.Corto = "Envisage la possibilité de dormir";
//         team.Lucas = "Transcende son humanité";
//         team.Martin = "Prépare ses grands airs pour le jour J";
//         team.Raphael = "Rassemble son courage";
//         team.moral = "Inshallah";
//         return "c:";
//     }
// }